...
// "workflow_run" can reference the triggerent event `head_sha`
// https://docs.github.com/en/rest/reference/actions#get-a-workflow-run
function getSHA(): string {
  return context.payload.pull_request?.head.sha ?? context.payload.workflow_run?.head_sha ?? context.sha
}
